...
//		$pdf->MultiCell(80,3,utf8_decode(urldecode($data["nodoReceptor"]["nombre"])),0);
		...
		$pdf->SetY($pdf->GetY());
		$pdf->SetX($x);
		$pdf->MultiCell(129,3,utf8_decode("TUXTLA GUTIERREZ, CHIAPAS. ".$data["fecha"]),1, "C", 1);
		...
		$pdf->SetY($pdf->GetY());
		$pdf->SetX($x);
		$pdf->MultiCell(75,3,$this->Util()->CadenaOriginalVariableFormat($data["timbreFiscal"]["FechaTimbrado"],false,false),1, "C", 1);
		...
		$pdf->SetY($y);
		$pdf->SetX($x);
		$pdf->MultiCell(80,3,$this->Util()->DecodeVal($data["formaDePago"]),1, "C", 1);
		...
		$pdf->SetY($y);
		$pdf->SetX($x);
		$pdf->MultiCell(74,3,$this->Util()->DecodeVal($data["metodoDePago"].". ".$add),1, "C", 1);
...
//					$this->Util()->CadenaOriginalVariableFormat($concepto["noIdentificacion"],false,false), 
	...
	$letra = $temp->letra();
		...
		$pdf->SetY($y);
		$pdf->SetX($x);
		$pdf->MultiCell(174,3,$this->Util()->DecodeVal($letra),1, "C", 1);
		...
		$pdf->SetY($setY);
		$pdf->SetX($x);
		$pdf->MultiCell(30,3,utf8_decode("Subtotal"),1, "C", 1);
		...
		$pdf->SetY($setY);
		$pdf->SetX($x);
		$pdf->MultiCell(34,3,"$".$this->Util()->CadenaOriginalPDFFormat($totales["subtotal"], true,false),1, "R", 1);
		...
		$pdf->SetY($setY);
		$pdf->SetX($x);
		$pdf->MultiCell(30,3,utf8_decode("Descuento"),1, "C", 1);
		...
		$pdf->SetY($setY);
		$pdf->SetX($x);
		$pdf->MultiCell(34,3,"$".$this->Util()->CadenaOriginalPDFFormat($totales["descuento"], true,false),1, "R", 1);
		...
		$pdf->SetY($setY);
		$pdf->SetX($x);
		$pdf->MultiCell(30,3,utf8_decode($totales["tasaIva"]."% IVA"),1, "C", 1);
		...
		$pdf->SetY($setY);
		$pdf->SetX($x);
		$pdf->MultiCell(34,3,"$".$this->Util()->CadenaOriginalPDFFormat($totales["iva"], true,false),1, "R", 1);
		...
		if($totales["retIva"] != 0)
		{
			...
			$pdf->SetY($setY);
			$pdf->SetX($x);
			$pdf->MultiCell(30,3,utf8_decode("Ret. IVA"),1, "C", 1);
			...
			$pdf->SetY($setY);
			$pdf->SetX($x);
			$pdf->MultiCell(34,3,"$".$this->Util()->CadenaOriginalPDFFormat($totales["retIva"], true,false),1, "R", 1);
		}
		...
		if($totales["retIsr"] != 0)
		{
			...
			$pdf->SetY($setY);
			$pdf->SetX($x);
			$pdf->MultiCell(30,3,utf8_decode("Ret. ISR"),1, "C", 1);
			...
			$pdf->SetY($setY);
			$pdf->SetX($x);
			$pdf->MultiCell(34,3,"$".$this->Util()->CadenaOriginalPDFFormat($totales["retIsr"], true,false),1, "R", 1);
		}
			...
			$pdf->SetY($setY);
			$pdf->SetX($x);
			$pdf->MultiCell(30,3,utf8_decode("Total"),1, "C", 1);
			...
			$pdf->SetY($setY);
			$pdf->SetX($x);
			$pdf->MultiCell(34,3,"$".$this->Util()->CadenaOriginalPDFFormat($totales["total2"], true,false),1, "R", 1);

<?php
		...
		$pdf->SetY($pdf->GetY());
		$pdf->SetX($xstart);
		$pdf->MultiCell(150,4,utf8_decode("ALFREDO ALVARADO GUTIERREZ"),0, "C");

		$pdf->SetFont('arial','B',8);
		$pdf->SetY($pdf->GetY());
		$pdf->SetX($xstart);
		$pdf->MultiCell(150,3,"R. F. C. AAGA920912Q77 CURP: AAGA920912HCSLTL03",0, "C");
		...
		$pdf->SetY($pdf->GetY());
		$pdf->SetX($xstart);
		$pdf->MultiCell(150,3,utf8_decode("CALLE 4 PONIENTE NORTE NO. 227 COL. TERAN TUXTLA GUTIERREZ, CHIAPAS. C.P. 29050"),0, "C");

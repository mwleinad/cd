...
class Override extends Comprobante
{
	function GeneratePDF($data, $serie, $totales, $nodoEmisor, $nodoReceptor, $nodosConceptos,$empresa, $cancelado = 0, $vistaPrevia = 0)
	{
  	...
  	$pdf->Cell(20,10,$data["comprobante"]["nombre"],0,0,'C');
		...
		$pdf->Image(DOC_ROOT."/images/fondo_285.JPG",50,70, 112,112); 		
...
//		$pdf->MultiCell(80,3,utf8_decode(urldecode($data["nodoReceptor"]["nombre"])),0);
		...
		switch($_SESSION["empresaId"])
		{
			case 285: $pdf->MultiCell(129,3,utf8_decode("CALLE BUGAMBILIA No75 FRACCIONAMIENTO AMPLIACION PARAISO, CINTALAPA, CHIAPAS\n".$data["timbreFiscal"]["FechaTimbrado"]),1, "C", 1); break;
			case 176: $pdf->MultiCell(129,3,utf8_decode("18 PONIENTE SUR No 1163-A  COL XAMAIPAK POPULAR CP 29060\n".$data["timbreFiscal"]["FechaTimbrado"]),1, "C", 1); break;
			case 470: $pdf->MultiCell(129,3,utf8_decode("CALLE BELLORITA MZ 13 LT 9; COL. PASO LIMON C.P. 29045 TUXTLA GUTIERREZ CHIAPAS\n".$data["timbreFiscal"]["FechaTimbrado"]),1, "C", 1); break;
			case 516: $pdf->MultiCell(129,3,utf8_decode("ANDADOR PASO DEL CORO 216, COL. CHAPULTEPEC C.P. 29027, TUXTLA GUTIERREZ CHIAPAS\n".$data["timbreFiscal"]["FechaTimbrado"]),1, "C", 1); break;
		}

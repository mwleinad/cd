<div class="popupheader" style="z-index:70">
	...
	<div id="ftitl">
		<div class="flabel">Ver Log</div>
		<div id="vtitl"><span title="Titulo">Ver Log</span></div>
	</div>
...
<div class="wrapp">
	{include file="{$DOC_ROOT}/templates/forms/add-log.tpl"}
	{include file="{$DOC_ROOT}/templates/lists/log.tpl"}
</div>

<div class="popupheader" style="z-index:70">
	...
	<div id="ftitl">
		<div class="flabel">Agregar simulador</div>
		<div id="vtitl"><span title="Titulo">Agregar simulador</span></div>
	</div>
...
<div class="wrapper">
	{include file="{$DOC_ROOT}/templates/forms/add-simulador.tpl"}
</div>

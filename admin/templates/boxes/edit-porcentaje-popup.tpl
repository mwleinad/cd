<div class="popupheader" style="z-index:70">
	...
	<div id="ftitl">
		<div class="flabel">Editar Porcentaje</div>
		<div id="vtitl"><span title="Titulo">Ver Porcentaje</span></div>
	</div>
...
<div class="wrapper">
	{include file="{$DOC_ROOT}/templates/forms/edit-comisionista.tpl"}
</div>

<div class="popupheader" style="z-index:70">
	...
	<div id="ftitl">
		<div class="flabel">Editando Paquete de Folios</div>
		<div id="vtitl"><span title="Titulo">Editando Paquete de Folios</span></div>
	</div>
...
<div class="wrapper">
	{include file="{$DOC_ROOT}/templates/forms/edit-paqFolios.tpl"}
</div>

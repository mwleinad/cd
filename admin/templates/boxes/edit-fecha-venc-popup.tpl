<div class="popupheader" style="z-index:70">
	...
	<div id="ftitl">
		<div class="flabel">Editar Limite de Folios y Fecha de Vencimiento</div>
		<div id="vtitl"><span title="Titulo">Editar Limite de Folios y Fecha de Vencimiento</span></div>
	</div>
...
<div class="wrapper">
	{include file="{$DOC_ROOT}/templates/forms/edit-fecha-venc.tpl"}
</div>

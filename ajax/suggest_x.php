...
switch($_POST["type"])
{
	...
	{
	?>
		<div style="border:solid; border-width:1px; border-color:#000; background-color:#FFFFE6; color:#666; padding:3px; width:400px" class="closeSuggestProductoDiv">No hay productos
	  </div>
<?php 		
	}

...
function VistaPreviaComprobante()
{
	...
	if(!confirm(message))
  {
	...
	{
  	parameters: {nuevaFactura: nuevaFactura, observaciones: $('observaciones').value, type: "vistaPreviaComprobante", reviso: reviso, autorizo: autorizo, recibio: recibio, vobo: vobo, pago: pago, porcentajeISH: porcentajeISH, tiempoLimite:tiempoLimite, formatoNormal:formatoNormal, referencia:referencia},
		method:'post',

...
function showControls(nextType,nextContent,prevType,prevContent){var $nextHtml=$('<a href="" class="bx-next"></a>');var $prevHtml=$('<a href="" class="bx-prev"></a>');if(nextType=='text'){$nextHtml.html(nextContent);}else{$nextHtml.html('<img src="file:///Arturoso/Users/macbook/Documents/prueba linko/images/js/'+nextContent+'" />');}
if(prevType=='text'){$prevHtml.html(prevContent);}else{$prevHtml.html('<img src="file:///Arturoso/Users/macbook/Documents/prueba linko/images/js/'+prevContent+'" />');}
...
function showAutoControls(startType,startContent,stopType,stopContent){$autoControls=$('<a href="" class="bx-start"></a>');if(startType=='text'){$startContent=startContent;}else{$startContent='<img src="file:///Arturoso/Users/macbook/Documents/prueba linko/images/js/'+startContent+'" />';}
if(stopType=='text'){$stopContent=stopContent;}else{$stopContent='<img src="file:///Arturoso/Users/macbook/Documents/prueba linko/images/js/'+stopContent+'" />';}

<div id="divForm">
	<form id="nuevaFactura" name="nuevaFactura" method="post">
        ...
        <input type="hidden" id="fromAddenda" name="fromAddenda" value="Zepto" />
...
<span id="loadingDivConcepto"></span>
      <div class="formLine">
          ...
          <div style="width:90px;float:left">Unidad:</div>
          <div style="width:90px;float:left">V Unit S/IVA:</div>
          <div style="width:90px;float:left">V Unit C/IVA:</div>
          <div style="width:90px;float:left">Excento Iva:</div>
          <div style="width:90px;float:left">% IEPS:</div>
          <div style="width:90px;float:left">Orden de Compra:</div>
          <div style="width:90px;float:left">Item:</div>
      		<div style="clear:both"></div>
        </div>  
	</form>
      ...
      <div class="formLine">
          ...
          <input name="cantidad" id="cantidad" type="text" value="{$post.cantidad}"  size="3" class="largeInput" placeholder="Cantidad"/></div>
          ...
          <div style="width:90px;float:left">
            <input name="idRecepcion" id="idRecepcion" type="text" value="{$post.ieps}"  size="6" class="largeInput"  placeholder="Id Recepcion"/>
          </div>

          <div style="width:90px;float:left">
            <input name="item" id="item" type="text" value="{$post.ieps}"  size="6" class="largeInput"  placeholder="Item"/>
          </div>
          
          <div style="width:100px;float:left; cursor:pointer" id="agregarConceptoDiv" class="button"><span>Agregar</span></div>
      		<div style="clear:both"></div>
        </div>  
      <div class="formLine">
      ...
      <div class="formLine">
          <div style="width:30%;float:left">
          Categor&iacute;a: <input name="categoriaConcepto" id="categoriaConcepto" type="text" value="{$post.categoriaConcepto}"  size="100" class="largeInput"  placeholder="Categoria: Cambiar Si desea Crear una nueva categoria de Concepto."/>
</div>
      		<div style="clear:both"></div>
 					<hr />   
        </div>
     ...
     <div class="formLine">
          <div>Campos Addenda</div> 
  		</div>      
      
      <div class="formLine">
          <div style="width:400px;float:left">Referencia (Solo requerido para notas de Credito):</div> 
          <div style="width:110px;float:left">
         <input value="N/A" type="text" id="referencia" name="referencia"  class="largeInput" style="width:90px" /></div>

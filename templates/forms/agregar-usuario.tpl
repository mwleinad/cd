<div id="divForm">
    ...
    <fieldset>
       	<div class="formLine">
            ...
            <input name="tipoContrato" id="tipoContrato" type="text" size="30" class="largeInput wide2" value="{$post.tipoContrato}"/>
            ...
            <input name="periodicidadPago" id="periodicidadPago" type="text" size="30" class="largeInput wide2" value="{$post.periodicidadPago}"/>
            ...
            <input name="estado" id="estado" type="text" size="30" class="largeInput wide2" value="{$post.estado}"/>

<div id="divForm">
	<form id="nuevaFactura" name="nuevaFactura" method="post">
        ...
        <input type="hidden" id="fromAddenda" name="fromAddenda" value="Pepsico" />
...
<span id="loadingDivConcepto"></span>
      <div class="formLine">
          ...
          <div style="width:100px;float:left">Id Recepci&oacute;n:</div>
      		<div style="clear:both"></div>
        </div>  
	</form>
      ...
      <div class="formLine">
          ...
          <div style="width:100px;float:left">
            <input name="idRecepcion" id="idRecepcion" type="text" value="{$post.ieps}"  size="8" class="largeInput"  placeholder="Id Recepcion"/>
          </div>
     ...
     <div class="formLine">
      ...
      <div class="formLine">
         ...
         <input type="text" id="idPedido" name="idPedido"  class="largeInput" style="width:90px" /></div>
          ...
          <div style="width:90px;float:left">Id Solicitud de Pago:</div> 
          <div style="width:110px;float:left">
         ...
         <input type="text" id="referencia" name="referencia"  class="largeInput" style="width:90px" /></div>
          ...
          <div style="width:90px;float:left">Id del Proveedor:</div> 
          <div style="width:110px;float:left">

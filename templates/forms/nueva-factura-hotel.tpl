...
{/if}    
				<div>
        	Datos de Facturaci&oacute;n <span id="loadingDivDatosFactura"></span>
        </div>
        <div class="formLine" style="text-align:left;">
        <div style="width:90px;float:left">RFC:</div> 
        <div style="width:172px;float:left"><input name="rfc" id="rfc" type="text" value="{$post.rfc}" size="20" class="largeInput"/>
      ...
      <div class="formLine">
          ...
          <div style="width:90px;float:left">Pa&iacute;s:</div>
...
<span id="loadingDivConcepto"></span>
      <div class="formLine">
          <div style="width:120px;float:left">Cantidad:</div> 
          <div style="width:120px;float:left">No. Ident:</div> 
          <div style="width:120px;float:left">Unidad:</div>
          <div style="width:120px;float:left">Valor Unitario:</div>
          <div style="width:120px;float:left">Exento Iva:</div>
          <div style="width:120px;float:left">Exento Ish:</div>
      		<div style="clear:both"></div>
        </div>  
	</form>
      ...
      <div class="formLine">
          <div style="width:120px;float:left">
          <input name="cantidad" id="cantidad" type="text" value="{$post.cantidad}"  size="12" class="largeInput" placeholder="Cantidad"/></div>
          <div style="width:120px;float:left">
          <input name="noIdentificacion" id="noIdentificacion" type="text" value="{$post.noIdentificacion}"  size="12"  class="largeInput" placeholder="No. Identificacion"/>
          <div style="position:relative">
          ...
          <div style="width:120px;float:left">
          <input name="unidad" id="unidad" type="text" value="{$post.unidad}"  size="12" class="largeInput"  placeholder="Unidad"/></div>
          <div style="width:120px;float:left">
          <input name="valorUnitario" id="valorUnitario" type="text" value="{$post.valorUnitario}"  size="12" class="largeInput"  placeholder="Valor Unitario"/></div>
          <div style="width:120px;float:left">
          <select name="excentoIva" id="excentoIva" class="largeInput" style="width:100px">
          ...
          <div style="width:120px;float:left">
          <select name="excentoIsh" id="excentoIsh" class="largeInput" style="width:100px">

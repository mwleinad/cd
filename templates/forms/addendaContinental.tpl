<div id="divForm">
	<form id="nuevaFactura" name="nuevaFactura" method="post">
        ...
        <input type="hidden" id="fromAddenda" name="fromAddenda" value="Continental" />
...
<span id="loadingDivConcepto"></span>
      <div class="formLine">
          ...
          <div style="width:100px;float:left">Excento Iva:</div>
          <div style="width:100px;float:left">% IEPS:</div>
          <div style="width:100px;float:left">Embarque:</div>
          <div style="width:100px;float:left">Posicion PO:</div>
      		<div style="clear:both"></div>
        </div>  
	</form>
      ...
      <div class="formLine">
          ...
          <div style="width:100px;float:left">
            <input name="idRecepcion" id="idRecepcion" type="text" value="{$post.ieps}"  size="8" class="largeInput"  placeholder="# Embarque"/>
          </div>
          <div style="width:100px;float:left">
            <input name="item" id="item" type="text" value="{$post.ieps}"  size="8" class="largeInput"  placeholder="# Posicion PO"/>
          </div>
     ...
     <div class="formLine">
      ...
      <div class="formLine">
          <div style="width:90px;float:left">Id del Pedido:</div> 
          <div style="width:110px;float:left">
         <input type="text" id="idPedido" name="idPedido"  class="largeInput" style="width:90px" /></div>
          
          <div style="width:90px;float:left">Tipo Proveedor:</div> 
          <div style="width:210px;float:left">
          <select id="idSolicitudDePago" name="idSolicitudDePago" class="largeInput">
          <option value="F">Transportistas</option>
          <option value="G">Agentes Aduanales</option>
          <option value="P">Otros</option>
          </select>
					</div>

<!--          <div style="width:90px;float:left">Pedimento:</div> 
          <div style="width:110px;float:left">

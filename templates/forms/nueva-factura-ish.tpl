...
{/if}    
        ...
        <div class="formLine" style="text-align:left;">
        <div style="width:90px;float:left">Busca RFC o Raz&oacute;n Social:</div> 
      ...
      <div class="formLine">
      <!--aqui--XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX-->
...
<span id="loadingDivConcepto"></span>
      <div class="formLine">
          <div style="width:50px;float:left">Cant.:</div> 
          <div style="width:50px;float:left"># Ident:</div> 
          <div style="width:100px;float:left">Unidad:</div>
          <div style="width:100px;float:left">V Unit S/IVA:</div>
          <div style="width:100px;float:left">Valor Total:</div>
          <div style="width:60px;float:left">Exento Iva:</div>
          <div style="width:60px;float:left">% IEPS:</div>
          <div style="width:60px;float:left">% ISH:</div>
      		<div style="clear:both"></div>
        </div>  
	</form>
      ...
      <div class="formLine">
          ...
          <div style="width:50px;float:left">
          <input name="noIdentificacion" id="noIdentificacion" type="text" value="{$post.noIdentificacion}"  size="3"  class="largeInput" placeholder="# Id"/>
          <div style="position:relative">
          ...
          <select name="excentoIva" id="excentoIva" class="largeInput" style="width:50px">
         	{foreach from=$excentoIva item=iva}
          <option value="{$iva}">{$iva}</option> <br />
          {/foreach}
          </select></div>
          <div style="width:60px;float:left">
            <input name="iepsConcepto" id="iepsConcepto" type="text" value="{$post.ieps}"  size="4" class="largeInput"  placeholder="% IEPS"/>
          </div>
          <div style="width:60px;float:left">
            <input name="ishConcepto" id="ishConcepto" type="text" size="4" class="largeInput"  placeholder="% ISH" value="{$smarty.const.TASA_ISH}" onblur="UpdateValorUnitarioSinIva()" />
          </div>

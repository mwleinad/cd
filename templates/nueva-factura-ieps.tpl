...
{*}<div style="font-size:18px; border:solid; border-width:1px; background-color:#FF9; padding:5px">
	Existe un problema con el proveedor autorizado de certificaci&oacute;n (PAC) y por un par de horas no podr&aacute;n facturar. Disculpe los inconvenientes. Por favor, sea paciente.
</div>{*}
...
{if $info.version != "auto" && $certNuevo == ""}
  ...
  {/if}  
	...
	{include file="forms/nueva-factura-ieps.tpl"}

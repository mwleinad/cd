    ...
    {foreach from=$xmlData.pagos item=pago}
        <table width="100%" class="outline-table">
            ...
            <tr class="border-right border-bottom">
                ...
                <td class="left">{$pago.pago.Monto|number:$xmlData.cfdi.Moneda}</td>
                ...
                <td colspan="4" width="80%" class="pad-left no-border-left padding-vertical">
                    <table width="100%" class="outline-table no-border">
                        ...
                        <tr class="border-right font-smallest">
                            ...
                            <td class="center border-bottom">{$pago.doctoRelacionado.ImpSaldoAnt|number:$xmlData.cfdi.Moneda}</td>
                            <td class="center border-bottom">{$pago.doctoRelacionado.ImpPagado|number:$xmlData.cfdi.Moneda}</td>
                            <td class="center border-bottom">{$pago.doctoRelacionado.ImpSaldoInsoluto|number:$xmlData.cfdi.Moneda}</td>

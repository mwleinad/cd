...
{*}  <td>${$concepto.totalIsh|number_format:2:".":","}</td>{*}
  <td>${$concepto.totalIeps|number_format:2:".":","}</td>
  <td> <span class="linkBorrar" style="cursor:pointer" onClick="BorrarConcepto({$key})">Borrar</span>
</tr>
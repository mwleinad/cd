      ...
      <div id="ftitl">
    		<div class="flabel">Importe Total</div>
				<div id="vtitl"><span title="Titulo">Importe Total: ${$totalDesglosado.afterImpuestos}</span></div>
    	</div>
    ...
    <div class="wrapper">
			{include file="{$DOC_ROOT}/templates/forms/add-pagos.tpl"}
            <div id="pagoErrror"></div>
		</div>
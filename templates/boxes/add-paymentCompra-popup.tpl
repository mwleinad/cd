<div class="popupheader" style="z-index:70">
	...
	<div id="ftitl">
    	...
    	<div id="vtitl">
        	...
        	<br /><br />
        	No. Compra: {$infoComprobante.compraId}
    	</div>
	</div>
...
<div class="wrapper">
    <div align="center"><b>Deuda de la Compra:</b>
...
<div style="float:right; height:100%;">
    ...
    {include file="{$DOC_ROOT}/templates/forms/add-paymentCompra.tpl"}
    
	<div id="paymentContent">
	{include file="{$DOC_ROOT}/templates/lists/paymentsCompra.tpl"}
	</div>     
</div>

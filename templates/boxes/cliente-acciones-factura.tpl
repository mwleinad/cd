...
<table width="100%" cellpadding="0" cellspacing="0" id="box-table-a" summary="Employee Pay Sheet">
            ...
            <tbody> 
                <tr>
                <td width="34">
                <a href="{$WEB_ROOT}/cliente-sistema/ver-pdf/item/{$id_comprobante}" target="_blank">
                ...
                <td>
                <a href="{$WEB_ROOT}/cliente-sistema/descargar-pdf/item/{$id_comprobante}">
                	<img src="{$WEB_ROOT}/images/icons/descargar.png" border="0" />
                </a></td>
                <td>
                {if $info.version == "v3" || $info.version == "2" || $info.version == "construc"}
                <a href="{$WEB_ROOT}/cliente-sistema/descargar-xml/item/{$id_comprobante}">
                	<img src="{$WEB_ROOT}/images/icons/descargar.png" border="0" />
                </a>
                	{/if}
               </td>

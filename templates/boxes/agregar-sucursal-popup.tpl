      ...
      <div id="ftitl">
    	<div class="flabel">Agregar Sucursal</div>
			<div id="vtitl"><span title="Titulo">Agregar Sucursal</span></div>
    </div>
    ...
    <div class="wrapper">
			{include file="{$DOC_ROOT}/templates/forms/agregar-sucursal.tpl"}
		</div>
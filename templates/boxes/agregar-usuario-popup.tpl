      ...
      <div id="ftitl">
    		<div class="flabel">Agregar Empleado</div>
				<div id="vtitl"><span title="Titulo">Agregar Empleado</span></div>
    	</div>
    ...
    <div class="wrapper">
			{include file="{$DOC_ROOT}/templates/forms/agregar-usuario.tpl"}
		</div>
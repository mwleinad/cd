    ...
    <div class="wrapper">
			{if $infoUser.version == "v3" || $infoUser.version == "construc"}
      	{include file="{$DOC_ROOT}/templates/forms/editar-folios.tpl"}
      {elseif  $infoUser.version == "2" || $infoUser.version == "auto"}
				{include file="{$DOC_ROOT}/templates/forms/editar-folios-auto.tpl"}
      {/if}  
		</div>